...
| 13 | 已上线 | 打造AI备忘录，用coze数据库，搭建可做数据存储、查询、分析的助手 | 搭建agent |
| 14 | 已上线 | 打造爬虫bot，用coze单agent工作流，搭建抓取网页和知识库助手 | 搭建agent |
| 15 | 已上线 | 打造提示词编写助手，用coze多agnet，搭midjourney提示词编写助手 | 搭建agent |
