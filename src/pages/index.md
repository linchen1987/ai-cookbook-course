...
| 12月23日 | 视频教程 | 7 | （进阶）了解Dify在运行时启动的服务，简析Dify技术架构 | @六月 |
| 1月（暂定） | 视频教程 | 8 | 实操：视频课件制作流程公开，用AI克隆声音并辅助做录播视频 | @六月 |

| 上线时间 | 学习形式 | | 使用Dify完成各类任务实操（积累基础搭建经验） | 辅导老师 |
| --- | --- | --- | --- | --- |
| 已上线 | 文档教程 | 9 | 项目场景：微信变AI，把Dify搭建的AI应用接入微信个人号 | @link /@ning |
| 1月17日 | 文档教程 | 10 | 项目场景：批量文档翻译，用Dify搭建可以翻译电子文档的神器 | @凯峰 |
| 2月7日 | 文档教程 | 11 | 项目场景：网页抓取分析，用Dify搭建帮你抓取并分析指定网页的助手 | @ning |
| 2月17日 | 文档教程 | 12 | 项目场景：文档数据分析，用Dify搭建Excel、PDF等文档的分析助手 | @凯峰 |
| 2月24日 | 文档教程 | 13 | 项目场景：个性文稿撰写，搭建可以仿照风格和格式要求撰写文稿的助手 | @凯峰 |
| 2月28日 | 文档教程 | 14 | 项目场景：音频-文本互转化，用Dify制作音频转文本，文本转音频类助手 | @ning |
