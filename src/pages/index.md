...
| 直播待定 | 5 | 数据分析，用Dify搭建网络信息分析工作流，辅助业务经营 | 陈琨@AI产品经理 |
| 直播待定 | 6 | AI多模态，把Dify作为LLMops平台，探索AI多模态方向，项目实践 | Eric@AI产品经理 |
| 直播待定 | 7 | AI应用落地的总结与思考，寻找高价值场景 | 徐司宇@AI产品经理 |
| 直播待定 | 8 | 基于开源项目Dify on WeChat，把Dify接入微信生态实践(填坑版) | 方圆@程序员、开源爱好者 |
