...
从入门学习难度，Dify 的可视化操作更贴近研发思维，上手难度可能高些。但Dify有非常多使用场景优势，特别适合需要完成专业任务的职场人
...
- 开放性：Dify 支持一键导入或导出 AI 应用和工作流文件到任何 Dify 系统，几乎没有限制，你的数字资源完全属于你。
- 开源开放：Dify的开源和开放性，可以直接查看Dify工具以及你的工作流文件源码，方便在基础上进行开发
- 适合工作场景使用：非研发人员使用Dify搭建业务流程框架、demo，由研发人员实现技术细节，协作完成复杂工作场景任务
...
> 为什么每周上线一个项目教程，不集中开班
> 1. 工作之余每周学一个项目，可能刚刚好，坚持学完是关键。高强度开班，有时很难坚持完。
> 2. 我们希望把这里打造成长期陪伴的学习社区，一起学习包括Dify在内对自己长期成长有帮助的AI技能。
> 3. Dify发展太快了，有新功能，新使用场景探索出来，我们会根据需要更新教程。

| 上线时间 | 学习形式 | | 学习Dify功能实操（建立Dify使用知识结构） | 辅导老师 |
| --- | --- | --- | --- | --- |
| 已上线 | 文档教程 | 1 | 实操：在电脑本地安装dify并进行基础配置 | @ning |
| 已上线 | 文档教程 | 2 | 实操：购买云服务器，并部署dify，绑定域名公开访问 | @link /@ning |
| 已上线 | 视频教程 | 3 | 知识：理解RAG的工作原理，以及学习用Dify实现RAG（案例：AI审批报销） | @六月 /@ning |
| 11月29日 | 视频教程 | 4 | 实操：Dify的RAG能力实践，搭建AI问答应用，并通过工作流更新知识库 | @六月 /@ning |
| 12月6日 | 视频教程 | 5 | 实操：提升知识库效果，数据基础预处理方法介绍 | @六月 |
| 12月13日 | 视频教程 | 6 | 实操：Dify的两种工作流能力介绍与AI应用实践 | @六月 |
...
更多学习内容制作中，欢迎扫描下方二维码联系我们分享你的Dify使用经验
