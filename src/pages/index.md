...
| 6 | 已上线 | 探索Google模型平台Vertex，部署claude并接入自己的AI对话工具 | 模型平台云端部署 |
| 7 | 已上线 | 打造自己的"干货"信息流，抓取订阅号内容，变为RSS订阅并用AI再加工 | 通用搭建技能 |
| 8 | 已上线 | 打造基于Markdown个人博客，并用GitHub和Cloudflare Pages管理发布 | 通用搭建技能 |
| 9 | 已上线 | 解决需要"企业邮箱"注册服务困扰，打造个人域名后缀的"企业邮箱" | 通用搭建技能 |
| 10 | 已上线 | 详解在个人电脑安装Dify以及通过配置环境变量和Docker绑定第三方服务 | 搭建agent |
...
> 第2个、第5个两个项目涉及学习通过ollama在本地电脑运行自己下载、微调的模型。目前教程是在Mac M2 16G内存的电脑上进行流畅操作演示。如电脑硬件无法达到要求，可以尝试下载更小参数的模型使用。
...
#### 项目2：打造本地个人知识库，让文档不落灰，通过电脑本地运行模型并实现RAG
...
#### 项目3：打造拥有AI能力的飞书应用，把FastGPT创建的bot接入飞书机器人
...
#### 项目5：上手微调，在云端微调llama3-8b实操，并在电脑本地使用微调后的模型
...
#### 项目6：打造稳定使用claude模型方案，利用google云把claude接入"套壳"对话工具
...
#### 项目7：打造自己的"干货"信息流，抓取订阅号B站内容，变为RSS订阅并用AI再加工
...
#### 项目8：打造基于Markdown个人博客，并用GitHub和Cloudflare Pages管理发布
...
#### 项目9：解决需要"企业邮箱"注册服务困扰，打造个人域名后缀的"企业邮箱"
...
#### 项目10：打造超低花费的agent制作环境，带你在电脑本地部署dify并制作agent
...
#### 项目12：把个人微信变成AI小助手，把dify搭建的agent接入个人微信
