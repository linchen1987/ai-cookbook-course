...
| 已上线 | 视频教程 | 3 | 知识：理解RAG的工作原理，以及如何用Dify实现RAG（案例：报销审批） | @六月/@ning |
| 11月29日 | 视频教程 | 4 | 实操：Dify的RAG能力案例实践，搭建基于私有文档的AI问答应用 | @六月 |
...
| --- | --- | --- | --- | --- |
| 已上线 | 文档教程 | 8 | 项目场景：微信变AI，把Dify搭建的AI应用接入微信个人号 | @link |
...
| 视频直播 | 5 | 从企业视角看待AI大模型落地(公开课) | 王健@企业架构师 |
| 视频直播 | 6 | 数据分析，用Dify搭建网络信息分析工作流，辅助业务经营 | 陈琨@AI产品经理 |
| 视频直播 | 7 | AI多模态，把Dify作为LLMops平台，探索AI多模态方向，项目实践 | Eric@AI产品经理 |
...
> 两门课389元= 26+个实操项目教程+多场直播，祝你成为更懂操作使用AI的职场达人
> 
</div>
